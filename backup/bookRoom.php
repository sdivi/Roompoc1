		...
		<div class="col-md-6">
			...
			<div class="form-group">
				<div class="col-md-offset-5 col-md-7">
					<button class="btn btn-primary" ng-click="tab1Flag=true;tab2Flag=false;tab3Flag=false;tab4Flag=false;tab1Class='active';tab2Class='';tab3Class='';tab4Class=''" style="padding: 6px 20px;">Edit</button>
